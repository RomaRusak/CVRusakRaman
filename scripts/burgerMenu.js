...
document.querySelector('.burger-menu-wrapper').addEventListener('click', () => {
    ...
    document.querySelector('.burger-menu-wrapper').classList.toggle('burger-menu-close')
})

window.addEventListener('resize', () => {
    if (window.screen.width > 1024 && burgerMenu.classList.contains('burger-menu-close')) {
